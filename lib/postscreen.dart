        ...
        child: Column(
          ...
          children: [
              ...
              subtitle: Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xff6A6B6D)),
                  ),
                  Text("4d.", style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xff6A6B6D))),
                ],
              ),
            ...
            Padding(
              ...
              child: Text("Alhamdulillah! I'm honored to receive the Certificate of Achievement for successfully completing the 45 Days Leading with Character Bootcamp 2025 at Superior University Lahore und the visionary leadership of Prof. Dr. Sumaira Rehman. (Rector Superior University)."),
            ),
            Container(
              ...
              // color: Colors.amber,
              decoration: BoxDecoration(
                image: DecorationImage(image: AssetImage("assets/sirr.png")),
              ),
            ),
            ...
            Row(
              children: [
                ...
                Text("M Jameel Summra +108               24 comments",style: TextStyle(color: Color(0xff6A6B6D)),)
